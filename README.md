...
Clean-room creature-collection — creature collection conventions (catch, train, battle)
...
- `src/archetype.ts` — deterministic core logic (SpeciesRegistry, CaptureFormula)
