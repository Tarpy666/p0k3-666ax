# P0K3-666AX — Build Plan (next agent brief)

**Genre:** creature-collection · **Era inspiration:** 1996 · **Target engine:** web
...
(P0K3-666AX). Mechanics are genre conventions; nothing is cloned — no code,
...
3. Depth loop (procedural variety, moddable rules) — modules: SpeciesRegistry, CaptureFormula.
